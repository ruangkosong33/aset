...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Sub Ruang</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="card card-info">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="post" action="{{route ('ruang.update', $ruang->id)}}" class="form-horizontal">
          @csrf
          @method('PUT')
          <div class="card-body">
            <div class="form-group row">
              <label for="nama_ruang" class="col-sm-2 col-form-label">Sub Ruang</label>
              <div class="col-sm-6">
